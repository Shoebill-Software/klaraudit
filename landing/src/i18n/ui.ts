...
const en = {
  ...
  rules: {
    ...
    bands: [
      ...
      },
      {
        status: 'WARNING',
        range: '60-84',
        note: 'Issues remain. Not a clean client handover.',
      },
      {
  ...
  pricing: {
    eyebrow: 'License',
    title: 'Open Source CLI and Agency License',
    lead: 'The scanner is free to run locally. The Agency License adds branded A4 PDF reports and client handover rights. Checkout via Lemon Squeezy.',
    colFeature: 'Parameter',
    colFree: 'Open Source CLI',
    colAgency: 'Agency License',
    freeTag: 'Free',
    agencyTag: '$79 one-time',
    rows: [
      { feature: 'Price', free: '$0', agency: '$79 USD, one-time' },
      { feature: 'License', free: 'MIT', agency: 'Agency license (client handover)' },
      { feature: 'Runtime', free: 'Local npx or Docker', agency: 'Local npx or Docker' },
      { feature: 'Output', free: 'Terminal, JSON', agency: 'Terminal, JSON, branded A4 PDF' },
      { feature: 'CI/CD gate', free: '--ci exit codes', agency: '--ci exit codes' },
      { feature: 'Cloud dependency', free: 'None', agency: 'None' },
      { feature: 'Client handover', free: 'No branded PDF rights', agency: 'Branded A4 PDF, handover rights' },
    ],
    ctaGithub: 'Clone the CLI',
    ctaBuy: 'Buy Agency License ($79)',
    footnote:
...
const de = {
  ...
  rules: {
    ...
    bands: [
      ...
      },
      {
        status: 'WARNING',
        range: '60-84',
        note: 'Befunde bleiben. Keine saubere Mandantenübergabe.',
      },
      {
        status: 'NON_COMPLIANT',
        range: '< 60',
  ...
  pricing: {
    eyebrow: 'Lizenz',
    title: 'Open-Source-CLI und Agency License',
    lead: 'Der Scanner ist lokal kostenfrei. Die Agency License ergänzt gebrandete A4-PDF-Berichte und Mandantenübergaberechte. Kauf über Lemon Squeezy.',
    colFeature: 'Parameter',
    colFree: 'Open-Source-CLI',
    colAgency: 'Agency License',
    freeTag: 'Kostenlos',
    agencyTag: '79 USD, einmalig',
    rows: [
      { feature: 'Preis', free: '0 USD', agency: '79 USD, einmalig' },
      { feature: 'Lizenz', free: 'MIT', agency: 'Agency License (Mandantenübergabe)' },
      { feature: 'Laufzeitumgebung', free: 'Lokal per npx oder Docker', agency: 'Lokal per npx oder Docker' },
      { feature: 'Ausgabe', free: 'Terminal, JSON', agency: 'Terminal, JSON, gebrandetes A4-PDF' },
      { feature: 'CI/CD-Gate', free: '--ci Exit-Codes', agency: '--ci Exit-Codes' },
      { feature: 'Cloud-Abhängigkeit', free: 'Keine', agency: 'Keine' },
      { feature: 'Mandantenübergabe', free: 'Keine PDF-Branding-Rechte', agency: 'Gebrandetes A4-PDF, Übergaberechte' },
    ],
    ctaGithub: 'CLI klonen',
    ctaBuy: 'Agency License kaufen (79 USD)',
    footnote:
...
const es = {
  ...
  rules: {
    ...
    bands: [
      ...
      },
      {
        status: 'WARNING',
        range: '60-84',
        note: 'Siguen existiendo problemas. No es una entrega limpia al cliente.',
      },
      {
        status: 'NON_COMPLIANT',
        range: '< 60',
  ...
  pricing: {
    eyebrow: 'Licencia',
    title: 'CLI de código abierto y licencia Agency',
    lead: 'El escáner se puede ejecutar localmente sin coste. La licencia Agency añade informes PDF A4 con marca y derechos de entrega al cliente. Pago a través de Lemon Squeezy.',
    colFeature: 'Parámetro',
    colFree: 'CLI de código abierto',
    colAgency: 'Licencia Agency',
    freeTag: 'Gratis',
    agencyTag: '79 USD, pago único',
    rows: [
      { feature: 'Precio', free: '0 USD', agency: '79 USD, pago único' },
      { feature: 'Licencia', free: 'MIT', agency: 'Licencia Agency (entrega al cliente)' },
      { feature: 'Entorno de ejecución', free: 'npx o Docker local', agency: 'npx o Docker local' },
      { feature: 'Salida', free: 'Terminal, JSON', agency: 'Terminal, JSON, PDF A4 con marca' },
      { feature: 'Puerta CI/CD', free: 'códigos de salida --ci', agency: 'códigos de salida --ci' },
      { feature: 'Dependencia de nube', free: 'Ninguna', agency: 'Ninguna' },
      { feature: 'Entrega al cliente', free: 'Sin derechos de PDF con marca', agency: 'PDF A4 con marca y derechos de entrega' },
    ],
    ctaGithub: 'Clonar la CLI',
    ctaBuy: 'Comprar licencia Agency (79 USD)',
    footnote:
